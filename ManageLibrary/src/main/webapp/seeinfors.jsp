...
<head>
    ...
    <title> See infors</title>
</head>
<body>
<%
    String tenFilter = request.getParameter("tenFilter");
    String ngayMuonFilter = request.getParameter("ngayMuonFilter");
    String maThuThuFilter = request.getParameter("maThuThuFilter");
    String maSinhVienFilter = request.getParameter("maSinhVienFilter");
    String trangThaiFilter = request.getParameter("trangThaiFilter");
    String maSachFilter = request.getParameter("maSachFilter"); 

    List<muontra> muontraList = muontraDB.getFilteredMuonTra(tenFilter, ngayMuonFilter, maThuThuFilter, maSinhVienFilter, trangThaiFilter, maSachFilter);
%>
    <div id="header">
        <div class="banner">
    ...
    <div id="main">
        <div class="form-login">
            <div class="top-main">
                <div class="tit">
                    <h3>Kiểm tra thông tin mượn trả</h3>
                </div>
                <form action="addinfors.jsp">
	                <div class="">
	                  <div class="">
	                    <input style="width: 200px" type="submit"  value="Thêm thông tin mượn trả"></input>
	                  </div>
	                </div>
            	</form>
            </div>
            ...
            <div class="filter-form">
			    <form action="seeinfors.jsp" method="get">
			    	<label>Tên sinh viên:</label>
			        <input type="text" name="tenFilter" value="<%= (tenFilter != null) ? tenFilter : "" %>">
			        <label>Ngày mượn: </label>
			        <input type="text" name="ngayMuonFilter" value="<%= (ngayMuonFilter != null) ? ngayMuonFilter : "" %>"> 
			      	<label>Mã thủ thư: </label>
			        <input type="text" name="maThuThuFilter" value="<%= (maThuThuFilter != null) ? maThuThuFilter : "" %>"><br>
			        <label>Mã sinh viên:</label>
			        <input type="text" name="maSinhVienFilter" value="<%= (maSinhVienFilter != null) ? maSinhVienFilter : "" %>">
			        <label>Trạng thái: </label>
			        <input type="text" name="trangThaiFilter" value="<%= (trangThaiFilter != null) ? trangThaiFilter : "" %>">
			        <label>Mã sách:</label>
                	<input type="text" name="maSachFilter" value="<%= (maSachFilter != null) ? maSachFilter : "" %>"> 
                    ...
                    %> 
                            ...
                            <tr>
                                ...
                                <td style="display: flex; justify-content: flex-start;gap:10px">
                                    ...
                                    <form action="updateinfors.jsp">
                                        <input type="hidden" name="mamuontra" value="<%=muontra.getMamuontra()%>">
                                        <input style="width: 55px; padding-left:10px" class="btn btn-outline-dark" type="submit"  value="Sửa">
                                    </form>
                                	<script>
	                                	function confirmDelete(maMuonTra) {
	                                        var isConfirmed = confirm("Bạn có chắc chắn muốn xóa mã mượn trả: " + maMuonTra + "?");
	
	                                        return isConfirmed;
	                                    }
								    </script>
                                    <form action="deleteinforServlet" onsubmit="return confirmDelete('<%=muontra.getMamuontra()%>')">
                                        <input type="hidden" name="mamuontra" value="<%=muontra.getMamuontra()%>">
                                        <input style="width: 55px; padding-left:10px" class="btn btn-outline-dark" type="submit"  value="Xóa">
                                    </form>
                                </td>
                            </tr>
                     <%
