...
<%
	...
	sach sach = sachDB.getBookById(masach);
%>
	<div id="header">
        <div class="banner">
    ...
    <div id="main">
        <div class="form-login">
            <h3>Update sách</h3>
            <form action="/ManageLibrary/updatebookServlet" method="get">
                <div class="f">
                  <label class="">Tên sách</label>
                  <div class="">
                    <input type="text" name="tensach" value="<%= sach.getTensach() %>">
                  </div>
                </div>
                <div>
                ...
                <div class="">
                  ...
                  <div class="">
                    <input type="text" name="slsach" value="<%= sach.getSlsach()%>">
                  </div>
                </div>
                <div class="">
                  <div class="">
